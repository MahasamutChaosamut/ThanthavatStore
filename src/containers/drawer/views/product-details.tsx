  ...
  return (
    <div className="flex flex-col w-full h-full">
      <div className="w-full flex justify-center relative px-30px py-20px">
        ...
        <h2 className="font-bold text-24px m-0">{state.item.name}</h2>
      </div>
        ...
        <div className="flex flex-col p-30px pt-0">
          ...
          <div className="flex flex-col items-start mb-4">
            ...
            <p className="flex items-center mb-5">
              ...
              <span className=" text-gray-500 text-11px">
                {state.item.quantity}{' '}
                {state.item.quantity > 0 ? 'ชิ้น' : 'piece'}
              </span>
            </p>
            ...
            {state.item.description && (
              <button
                ...
                aria-label="details"
              >
                {visibility === true ? 'แสดงน้อยลง' : 'แสดงเพิ่มเติม'}
              </button>
            )}
          </div>
          ...
          <div className="flex w-full flex-col">
            <div className="flex flex-col justify-start full mt-10 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-2">ชนิดทางการเกษตร</span>
            ...
            <div className="flex flex-col justify-start full mt-10 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-2">อัตราการใช้</span>
              <span className="font-normal text-13px text-gray-900 capitalize">
                {state.item.dosage}
              </span>
            </div>
            ...
            <div className="flex flex-col justify-start full mt-10 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-2">ผู้วางจำหน่าย</span>
              <span className="font-normal text-13px text-gray-900 capitalize">
